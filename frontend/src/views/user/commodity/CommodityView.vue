  ...
  <a-drawer
    ...
    <div style="font-size: 13px;font-family: SimHei" v-if="commodityData !== null">
      ...
      <a-row style="padding-left: 24px;padding-right: 24px;">
        ...
        <a-col :span="6">
          <a-input-number id="inputNumber" v-model="value" :min="1" :max="commodityData.reserve" style="width: 100%"/>
        </a-col>
      </a-row>
...
export default {
  ...
  methods: {
    ...
    handleSubmit () {
      this.commodityData.total = this.value
      this.$emit('success', this.commodityData)
    }
  }
}
</script>
