<template>
  <a-modal v-model="show" title="新增生鲜折扣设置" @cancel="onClose" :width="800">
    ...
    <a-form :form="form" layout="vertical">
      <a-row :gutter="20">
        <a-col :span="12">
          <a-form-item label='生鲜折扣设置姓名' v-bind="formItemLayout">
            <a-input disabled v-decorator="[
            'name',
            { rules: [{ required: true, message: '请输入生鲜折扣设置姓名!' }] }
            ]"/>
          </a-form-item>
        </a-col>
        <a-col :span="12">
